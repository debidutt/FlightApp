package demo.fly.app.mortarscreen;
...
import demo.fly.app.mortarflow.ModuleFactory;
import demo.fly.app.mortarflow.WithModule;
import demo.fly.app.mortarflow.WithModuleFactory;
 ...
 */
/**
 * Creates {@link MortarScope}s for screens that may be annotated with {@link WithModuleFactory}, {@link WithModule}.
 */
public class ScreenScoper {
    ...
    /**
     * Finds or creates the scope for the given screen, honoring its optional {@link WithModuleFactory} or {@link WithModule} annotation. Note that scopes are also created for unannotated screens.
     */
    public MortarScope getScreenScope(Resources resources, MortarScope parentScope, final String name, final Object screen) {
        ...
        //TODO: Explore Object Graph Service
//        if (childScope == null) {
        ...
        if (withModule != null) {
            ...
            if (parameters.length == 1) {
                ...
                if (!screenParameter.isInstance(screen)) {
                    throw new IllegalArgumentException(format("Module %s for screen %s should have a " + "constructor parameter that is a super class of %s", moduleClass.getName(), screen, screen.getClass().getName()));
                }
            }
            else {
